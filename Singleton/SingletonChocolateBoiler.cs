namespace Singleton
{
    public class SingletonChocolateBoiler :IChocolateBoiler
    {
        private static Boiler Boiler = new();
        private static readonly Lazy<SingletonChocolateBoiler> lazyInstance = new Lazy<SingletonChocolateBoiler>(() => new SingletonChocolateBoiler());
